...
import {useDeleteList} from '@app/requests/requests/use-delete-list';
import {useDialogContext} from '@common/ui/overlays/dialog/dialog-context';
import {ConfirmationDialog} from '@common/ui/overlays/dialog/confirmation-dialog';
import {Trans} from '@common/i18n/trans';
import React, {Fragment} from 'react';
import {getRequestLink, RequestLink} from '@app/requests/request-link';
import {Button} from '@common/ui/buttons/button';
import {Link} from 'react-router-dom';
import {DialogTrigger} from '@common/ui/overlays/dialog/dialog-trigger';
import {RequestByline} from '@app/requests/request-byline';
import {RequestDetails} from '@app/requests/request-details';
...
interface RequestIndexItemProps {
  list: Channel;
  user: User;
  showVisibility?: boolean;
}
export function RequestIndexItem({
  list,
  user,
  showVisibility = true,
}: RequestIndexItemProps) {
